import { FaAd, FaChartLine, FaEnvelope, FaHome, FaMoneyBill, FaSearch, FaShoppingCart, FaUser, FaUtensils } from "react-icons/fa";
        ...
        <div className="flex">
            <div className="w-64 min-h-screen bg-orange-400">
                <ul className="menu p-4 gap-4 pt-12">
                    {
                        isAdmin ? <>
                            <li><NavLink className='btn' to='/dashboard/admindashboard'><FaChartLine className="h-6 w-6" />Admin Dashboard</NavLink></li>
